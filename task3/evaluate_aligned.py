...
# Episodes where goal direction matches instruction
# Agent faces +X direction by default in habitat
# FORWARD → goal in +X direction
# LEFT    → goal in +Z direction  
# RIGHT   → goal in -Z direction
TEST_EPISODES = [
    # FORWARD — goal ahead (in +X)
    ...
    {"instruction": "Proceed straight ahead",
     "start": [-7.510, 0.072, -0.806],
     "goal":  [-5.084, 0.072, -1.585], "shortest": 2.55},

    # LEFT — goal to the left
    ...
    {"instruction": "Bear left at the corridor",
     "start": [ 0.085, 0.072,  0.830],
     "goal":  [-2.026, 0.072, -2.482], "shortest": 3.93},

    # RIGHT — goal to the right
    ...
    # STOP — goal is very close (agent should stop quickly)
